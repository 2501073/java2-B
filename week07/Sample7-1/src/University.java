public class University extends Student{
    ...
    public String partList() {
        ...
        for (int i = 0; i < parts.size(); i++)
            ...
            result += String.format(" 3d(%4.1f) ", parts.get(i).getScore(), score(parts.get(i).getScore(), 100));
        else if (parts.get(i).getPartName().equals("레포트"))
            result += String.format(" 3d(%4.1f) ", parts.get(i).getScore(), score(parts.get(i).getScore(), 20));
        else
            result += String.format(" 3d(%4.1f) ", parts.get(i).getScore(), score(parts.get(i).getScore(), 30));
        return result;
    }
